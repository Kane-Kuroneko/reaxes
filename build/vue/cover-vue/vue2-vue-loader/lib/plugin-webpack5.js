...
const id = 'vue2-vue-loader-plugin'
const NS = 'vue2-vue-loader'
...
class VueLoaderPlugin {
  apply(compiler) {
    ...
    for (const rawRule of rules) {
      ...
      vueRules = match(rawRule, 'foo.vue2.vue')
      if (!vueRules.length) {
        vueRules = match(rawRule, 'foo.vue2.vue.html')
      }
    ...
    const vueLoaderUseIndex = vueUse.findIndex((u) => {
      return /^vue2-vue-loader|(\/|\\|@)vue-loader/.test(u.loader)
    })
