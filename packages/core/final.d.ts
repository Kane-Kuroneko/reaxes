...
declare const Reaxes : typeof import('@@packages/core/Reaxes').Reaxes;
declare const Reaxper : typeof import('@@packages/core/Reaxper').Reaxper;
declare const Reaxlass : typeof import('@@packages/core/Reaxlass').Reaxlass;
declare const orzMobx : typeof import('@@packages/core/ORZMobx').orzMobx;

// declare module 'reaxes' {
// 	export const Reaxes : Reaxes;
// 	export const Reaxper : typeof import('reaxes').Reaxper;
// 	export const Reaxlass : typeof import('reaxes').Reaxlass;
